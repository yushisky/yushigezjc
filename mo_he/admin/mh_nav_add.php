<?php 
      ...
      //获取数据库名给予赋值=========
          ...
          // p($res);die;
          if($res){
            show_msg('添加成功','mh_nav_list.php');die;
          }else{
            show_msg('添加失败');die;
          }
      // }
	 ...
	 <div class="row">
        ...
        <form action="#" method="post" class="cmxform" enctype="multipart/form-data">
            ...
            <div class="panel-heading">
              ...
              <a href="mh_nav_list.php" class="btn btn-default btn-gradient dropdown-toggle"><span class="glyphicon glyphicon-chevron-left"></span></a>
            	  </div>
            </div>
            <div class="panel-body">
                ...
                <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon">导航栏路径</span>
