<?php 
      ...
      //获取数据库名给予赋值=========
          ...
          if($_FILES){
           ...
           // p($data);die;
          $table = 'mh_index_nav';//获取数据库名
          // p($table);die;
          $res = add($table,$data);
          // p($res);die;
          if($res){
            show_msg('添加成功','mh_index_nav_list.php');die;
          }else{
            show_msg('添加失败');die;
          }
        }
        ...
        <form action="#" method="post" class="cmxform" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                 ...
                 <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon">所属分类类型</span>
                    <select name="class" class="form-control">
                          <option value="1">图片组1</option>
                          <option value="2">图片组2</option>
                    </select>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="file" name="nav_img" value="" class="form-control" >
                </div>
                 <div class="form-group">
