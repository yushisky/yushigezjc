<?php
   ...
   include('../pagination.php');
    ...
    if(!empty($_GET['del'])){
      ...
      $sql = "delete from mh_newstext where new_id = ".$new_id;
      //print_r($sql);die;
      $res = mysql_query($sql);
  ...
  //================页码插件========================================
  $sql_count = "select count(*) as c from mh_newstext ";//as wc left join wd_case_cat as wcc on wc.case_class = wcc.case_cat_id
  ...
  $sql = "select * from mh_newstext  limit {$start},{$limit}";//as wc left join 
  $new_data = get_all($sql);
        ...
        <div class="col-md-12">
			<div class="panel">
                <div class="panel-heading">
                  ...
                  <a href="newstext_add.php" class="btn btn-info btn-gradient pull-right"><span class="glyphicons glyphicon-plus"></span> 添加管理</a>
                </div>
                ...
                <div class="panel-body">
                  <table class="table table-striped table-bordered table-hover dataTable">
                      ...
                      <?php foreach ($new_data as $key => $val){?>
                        ...
                        <td><?php echo cutstr($val['new_title'],0,12,'...');?></td>
                        <td><?php echo cutstr($val['new_img'],0,12,'...');?></td>
                        <td><?php echo $val['class'];?></td>
                        <td><?php echo $val['is_show'];?></td>
                        <td><?php echo $val['addtime'];?></td>
                        <td>
		                      <div class="btn-group">
		                        <a href="newstext_edit.php?update=1&new_id=<?php echo $val['new_id'];?>" class="btn btn-default btn-gradient"><span class="glyphicons glyphicon-pencil"></span></a>
