            ...
            <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon">所属分类类型</span>
                    <select name="class" class="form-control">
                          <option value="1">景区标题1组</option>
                          <option value="2">景区标题2组</option>
                          <option value="3">景区标题3组</option>
                          <option value="4">景区标题4组</option>
                          <option value="5">景区标题5组</option>
                          <option value="6">景区标题6组</option>
                          <option value="7">景区标题7组</option>
                    </select>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon">景区标题</span>
                ...
                <div class="input-group">
                    ...
                    <input type="file" name="spot_img" value="" class="form-control" >
                </div>
                 <div class="form-group">
