...
if(!empty($_GET['update'])){
  ...
  $sql = 'select * from wd_banner where banner_id = '.$banner_id;
 //p($sql);die;
  $banner_info = get_one($sql);
  // echo WEB_PATH.'/images/'.$banner_info['banner_img_url'];die;
 //p($case_info);die;
  }else{
  show_msg('非法进入','wd_banner_list.php');die;
  }
if(isset($_POST['active'])&&!empty($_POST['active'])){
  // p($_POST);die;
    $banner_id = $_POST['banner_id'];
    $data['title'] = $_POST['title'];
    $data['banner_class'] = $_POST['class'];
        ...
        <form action="#" method="post" class="cmxform" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="input-group">
                    ...
                    <input type="file" name="banner_img_url" id="aaa" value="<?php echo $banner_info['banner_img_url'];?>" class="form-control" >
                    <img width="100px" height="100" src="<?php echo WEB_PATH.'/images/'.$banner_info['banner_img_url'];?>">
                    <input type="hidden" name="old_banner_img_url" value="<?php echo $banner_info['banner_img_url']?>">
                </div>
                <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon">图片标题</span>
                    <input type="text" name="title" value="<?php echo $banner_info['title'];?>" class="form-control">
                  </div>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon">是否显示</span>
                    <select name="is_show" class="form-control">
                          <option value="1" <?php echo 1==$banner_info['is_show']?'selected':'';?>>显示</option>
                          <option value="2" <?php echo 2==$banner_info['is_show']?'selected':'';?>>隐藏</option>
                    </select>
                  </div>
                </div>
                <div class="form-group">
                    <div class="input-group"> <span class="input-group-addon">更新的时间</span>
                        <input type="data" name="data" value="<?php echo $banner_info['addtime'];?>" class="form-control">
                    </div>
                </div>
