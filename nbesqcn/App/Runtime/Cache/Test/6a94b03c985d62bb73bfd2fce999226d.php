...
<div class="f-l mt-60 ban_right ml-30">
	...
	<div class="serve_content f-l mt-20">
		...
		<div class="empty-placeholder hidden"></div>
			<div id="subNav">
				<ul class="f-l">
					<li class="adv_active"><a href="#hall_show" class="adv_door adv_active">酒店介绍</a></li>
					<li><a href="#checkCar" class="adv_source">商家位置</a></li>
					<li><a href="#alpha_price" class="adv_price">消费提示</a></li>
					<li><a href="#service_show" class="adv_transfer">环境展示</a></li>
					<li><a href="#pay_show" class="adv_payment">消费评价(1740)</a></li>
				</ul>
			</div>	
		<ul class="serve_titleone">
			<li id="hall_show">酒店介绍</li>
		</ul>
		<div class="form_map f-l mt-20">
			<ul class="hotl_pre">
				<p>基础设施</p>
				<li><img src="/Public/Test/images/sheshi1.jpg" alt=""></li>
				<li><img src="/Public/Test/images/sheshi2.jpg" alt=""></li>
				<li><img src="/Public/Test/images/sheshi2.jpg" alt=""></li>
				<li><img src="/Public/Test/images/sheshi3.jpg" alt=""></li>
				<li><img src="/Public/Test/images/sheshi4.jpg" alt=""></li>
				<li><img src="/Public/Test/images/sheshi5.jpg" alt=""></li>
				<li><img src="/Public/Test/images/sheshi6.jpg" alt=""></li>
				<li><img src="/Public/Test/images/sheshi7.jpg" alt=""></li>
				<li><img src="/Public/Test/images/sheshi9.jpg" alt=""></li>
				<li><img src="/Public/Test/images/sheshi10.jpg" alt=""></li>
				<li><img src="/Public/Test/images/sheshi11.jpg" alt="">
				<img class="pos_hot" src="/Public/Test/images/sheshi13.png" alt=""></li>
				<li><img src="/Public/Test/images/sheshi12.jpg" alt="">
				<img class="pos_hot" src="/Public/Test/images/sheshi13.png" alt=""></li>
			</ul>
		<div class="pre_conter">
			<ul class="pre_left">
				<li><span>酒店信息</span></li>
				<li class="por_he"><span>酒店介绍</span></li>
				<li ><span>酒店服务</span></li>
				<li><span>其它设施</span></li>
			</ul>
			<ul class="pre_right">
				<li> 2002年开业    <span>2011年装修</span>    <span>80间房</span></li>
				<li ><span>佛山市乐从凯来登酒店位于佛山顺德乐从繁华地段新马路28号信德大厦（乐从政府对面），毗邻国内著名的家具展览中心、塑料城及钢铁市场，离乐从核心步行街和威斯广场近2分钟路程，酒店各项配套设施齐全。一楼设有沐足,靠近乐从汽车交通中心,本酒店大众化的消费，星级的享受，环境优雅、静中带旺、安全舒适、交通方便，是商务出行的首选酒店。真诚欢迎您的到来！</span></li>
				<li><span>停车场   信用卡/银联卡收费    叫醒服务    行李寄存    多种语言服务人员    wifi</span></li>
				<li><span>暂无</span></li>
			</ul>
		</div>
		</div>
		<ul class="serve_titleone ">
				<li id="checkCar">商家位置</li>
			</ul>
		<div class="form_map f-l mt-20">
	...
	<div class="por_conter f-l">
		<ul class="serve_titleone">
			<li id="alpha_price">消费提示</li>
		</ul>
		<ul class="por_left  f-l">
			<li><span>优惠卷有效期</span></li>
			<li><span>预约提醒</span></li>
			<li  class="por_he"><span>入住须知</span></li>
			<li class="por_he"><span>优惠券使用</span></li>
		</ul>
		<ul class="por_right1 f-l">
			<li class="por_he1"><span>2014.11.1 至 2016.8.22（周末、法定节假日通用）</span></li>
			<li class="por_he1"><span>请提前一天预约，预约无需出示纳邦会员信息</span></li>
			<li class="por_he"><span>1.请在14:00以后入住并于次日12:00以前退房；如需提前入住或延时退房，请咨询店家
			<br>2.入住需要押金，金额以前台为准,并出示身份证（一人一证）豪华单人房限住2名/标准双人房限住2名成人入住，
			身高1.2米（不含）以上算成人
			<br>3.请不要携带宠物入住</span></li>
			<li class="por_he"><span>不可与其他优惠同享<br>
					不可使用同一优惠券连续入住<br>
					陶博会期间平日价优惠券不可用，请用户根据特殊日期的酒店价进行消费，为确保到店有房，请尽量选择提前
					预订。
			</span>
			</li>
		</ul>
	...
	<ul class="serve_titleone">
		<li id="service_show" >环境展示</li>
	</ul>
		<div>
			<ul>
				<li><img src="/Public/Test/images/hotltl2_03.png" alt=""></li>
				<li><img src="/Public/Test/images/hotl2_19.png" alt=""></li>
			</ul>
		</div>
	</div>
	<div class="clear_float"></div>
...
//优势页面点击子导航
	...
	$(window).scroll(function(){
		...
		}else if(targetTop > 1200 && targetTop < 1340){
				subNav_scroll($(".adv_source"));
		}else if(targetTop > 1540 && targetTop < 1900){
				subNav_scroll($(".adv_price"));
		}else if(targetTop > 2200 && targetTop < 2900){
				subNav_scroll($(".adv_transfer"));
		}else if(targetTop > 3000 && targetTop < 4000){
