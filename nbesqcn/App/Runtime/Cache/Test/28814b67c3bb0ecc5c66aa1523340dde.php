	...
	<div class="nav_conter f-l  mt-15 ml-30  mb-50">
		<div class="nav-1">
			...
			<ul class="nav-0">
				...
				<li class="bgnav-box"><a href="<?php echo U('appraise2');?>">&bull;&nbsp;差评</a><span class="f-r mr-10">&gt;</span></li>
			</ul>
		</div>
	</div>	
	<div class="nav_right col-xs-8 col-md-8 col-lg-8 mt-30 ml-50">
		<ul class="">
			<li><a href="<?php echo U('appraise');?>">全部</a></li>
			<li><a href="<?php echo U('appraise1');?>">好评</a></li>
			<p class="right_title"><span>差评</span></p>
		</ul>
	</div>
