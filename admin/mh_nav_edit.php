<?php
  include('../config/common.conf.php');
    if(!empty($_GET['update'])){
      $nav_id = $_GET['nav_id'];
      $sql = 'select * from mh_nav where nav_id = '.$nav_id;
     //p($sql);die;
      $nav_info = get_one($sql);
      // echo WEB_PATH.'/images/'.$banner_info['banner_img_url'];die;
     //p($case_info);die;
      }else{
      show_msg('非法进入','mh_nav_list.php');die;
      }
        ...
        <form action="#" method="post" class="cmxform" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon">导航栏名称</span>
                    <input type="text" name="title" value="<?php echo $nav_info['nav_name']?>" class="form-control">
                  </div>
                </div>
                 <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon">导航栏链接</span>
