...
<div class="content">
	<div class="lefter">
    	<div class="title">
        	<h2 class="cBlue fB"><?php echo ($us_data["artcat_name"]); ?><b class="cGrey fn"><?php echo ($us_data["artcat_enname"]); ?></b></h2>
        </div>
        <div class="intro">
        <?php if(is_array($us_info)): foreach($us_info as $key=>$val): ?><p><?php echo ($val["article_content"]); ?></p><?php endforeach; endif; ?>
        </div>
    </div>
	       <div class="righter">
    	<div class="rightBox">
