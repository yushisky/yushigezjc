...
<div class="nav">
    ...
    <ul id = "nav">
        <?php if(is_array($nav_data)): foreach($nav_data as $key=>$val): ?><li class="sel"><a href="<?php echo U('home/index/<?php echo ($val["nav_link;?>');"]); ?>"><?php echo ($val["nav_name"]); ?></a></li><?php endforeach; endif; ?>
         <!--<li><a href="<?php echo U('home/index/detail');?>">公司简介</a></li>
        <li><a href="<?php echo U('home/index/products');?>">产品展示</a></li>
        <li><a href="<?php echo U('home/index/knowledge');?>">行业知识</a></li>
        <li><a href="<?php echo U('home/index/guestbook');?>">客户留言</a></li>
        <li><a href="<?php echo U('home/index/contact_us');?>" class="nobg">联系我们</a></li> -->
