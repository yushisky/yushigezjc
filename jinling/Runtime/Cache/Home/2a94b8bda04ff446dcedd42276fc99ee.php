...
<div class="nav">
    ...
    <ul id = "nav">
        <li class="sel"><a href="index.html">首  页</a></li>
...
<div class="content">
	<div class="w475_l">
        ...
        <div class="intro">
                我公司前身是金能保温材料经营部，因扩大经营规模，于2009年3月变更为金陵贸易有限公司。1994年开始从事保温、保冷、吸音、耐火、化工、建材等产品的经营贸易，对控制产品质量方面具备非常好的经验，是中国1994年开始从事保温、保冷、吸音、耐火、化工、建材等产品的经营贸易，对控制产品质量方面具备非常好的经验，是中国东南地区最大的保温材料经营贸易公司之一。公司经营宗旨是：诚信经营，质量第一。欢迎您的洽谈！<a href="#" class="cBlue"> 查看更多...</a>
    ...
    <div class="w370_r">
        ...
        <ul class="list_r">
            <?php if(is_array($art_data)): foreach($art_data as $key=>$val): ?><li><a href="#"><?php echo ($val["article_title"]); ?></a><span class="time1"><?php echo (data($val["article_addtime "],"")); ?></span></li><?php endforeach; endif; ?>
            <!-- <li><a href="#">禁止保温材料现场调配 保证节能建材真正... </a><span class="time1">2009-07-10</span></li>
            <li><a href="#">节能65%烧结页岩空心砖面世 </a><span class="time1">2009-07-10</span></li>
