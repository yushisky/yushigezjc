        ...
        <div class="col-md-12">
			<div class="panel">
                <div class="panel-heading">
                  ...
                  <a href="<?php echo U('message_add');?>" class="btn btn-info btn-gradient pull-right"><span class="glyphicons glyphicon-plus"></span> 添加分类</a>
                </div>
                ...
                <div class="panel-body">
                  <table class="table table-striped table-bordered table-hover dataTable">
                      <tr class="active">
                       ...
                       <?php if(is_array($mag_data)): foreach($mag_data as $key=>$val): ?><tr class="success">
                        <td class="text-center"><input type="checkbox" value="1" name="idarr[]" class="cbox"></td>
                          <td><?php echo ($val["message_author"]); ?></td>
                          <td><?php echo ($val["message_content"]); ?></td>
                          <td><?php echo (date("y-m-d",$val["message_addtime "])); ?></td>
                        <td>
		                      <div class="btn-group">
		                        <a href="<?php echo U('message_edit');?>?update=1&id=<?php echo ($val["id"]); ?>" class="btn btn-default btn-gradient"><span class="glyphicons glyphicon-pencil"></span></a>
