        ...
        <div class="col-md-12">
			<div class="panel">
                <div class="panel-heading">
                  ...
                  <a href="<?php echo U('artcat_add');?>" class="btn btn-info btn-gradient pull-right"><span class="glyphicons glyphicon-plus"></span> 添加分类</a>
                </div>
                ...
                <div class="panel-body">
                  <table class="table table-striped table-bordered table-hover dataTable">
                      <tr class="active">
                       ...
                       <?php if(is_array($Art_data)): foreach($Art_data as $key=>$val): ?><tr class="success">
                        <td class="text-center"><input type="checkbox" value="1" name="idarr[]" class="cbox"></td>
                          <td><?php echo ($val["artcat_name"]); ?></td>
                          <td><?php echo ($val["artcat_enname"]); ?></td>
                          <td><?php echo (date("y-m-d",$val["artcat_addtime "])); ?></td>
                        <td>
		                      <div class="btn-group">
