	 ...
	 <div class="row">
        ...
        <form action="" method="post" class="cmxform">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon">文章分类英文名称</span>
                    <input type="text" name="enname" value="<?php echo ($info["artcat_enname"]); ?>" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                      <div class="input-group"> 
                    <span class="input-group-addon">更新时间</span>
                      <input class="form-control date-picker" id="class_code_cc_time_input" type="text" data-date-format="yyyymmdd" name="time" value="<?php echo ($info["artcat_addtime"]); ?>">
                </div>
                </div>
                </div>
