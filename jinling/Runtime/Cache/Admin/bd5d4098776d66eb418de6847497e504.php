	 ...
	 <div class="row">
        ...
        <form action="" method="post" class="cmxform">
            ...
            <div class="panel-heading">
              <div class="panel-title">编辑文章分类</div>
              <div class="panel-btns pull-right margin-left">
              <a href="<?php echo U('message_list');?>" class="btn btn-default btn-gradient dropdown-toggle"><span class="glyphicon glyphicon-chevron-left"></span></a>
            	  </div>
            </div>
            <div class="panel-body">
                ...
                <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon">作者</span>
                    <input type="text" name="author" value="<?php echo ($info["message_author"]); ?>" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon">留言内容</span>
                    <input type="text" name="content" value="<?php echo ($info["message_content"]); ?>" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                      <div class="input-group"> 
                    <span class="input-group-addon">留言时间</span>
                      <input class="form-control date-picker" id="class_code_cc_time_input" type="text" data-date-format="yyyymmdd" name="time" value="<?php echo ($info["message_addtime"]); ?>">
                </div>
                </div>
                </div>
