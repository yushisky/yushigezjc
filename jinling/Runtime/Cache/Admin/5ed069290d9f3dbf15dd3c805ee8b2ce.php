        ...
        <form action="" method="post" class="cmxform">
          <div class="panel">
            <div class="panel-heading">
              ...
              <a href="<?php echo U('article_list');?>" class="btn btn-default btn-gradient dropdown-toggle"><span class="glyphicon glyphicon-chevron-left"></span></a>
                </div>
            </div>
            <div class="panel-body">
                ...
                <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon">文章标题</span>
                    <input type="text" name="title" value="<?php echo ($info["article_title"]); ?>" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon">文章内容</span>
                    <input type="text" name="content" value="<?php echo ($info["article_content"]); ?>" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                      <div class="input-group"> 
                    <span class="input-group-addon">更新时间</span>
                      <input class="form-control date-picker" id="class_code_cc_time_input" type="text" data-date-format="yyyymmdd" name="time" value="<?php echo ($info["article_addtime"]); ?>">
                </div>
                </div>
                </div>
