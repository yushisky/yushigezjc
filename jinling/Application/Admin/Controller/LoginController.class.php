    ...
    public function index(){
      ...
      // echo 22222222;
        ...
        if($admin_info){
          ...
          $this->success('登录成功！','http://by1600015.pro.wdcase.com/jinling/index.php/admin/index',1);die;
        }else{
          $this->error('用户名或密码错误','http://by1600015.pro.wdcase.com/jinling/index.php/admin/login');die;
        }
        }else{
          // $this->error('验证码错误！','http://www.jinling.com/admin/login');die;
          $this->success('验证码错误！','http://by1600015.pro.wdcase.com/jinling/index.php/admin/login',1);die;
        }
      }
