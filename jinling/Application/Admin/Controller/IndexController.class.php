...
class IndexController extends Controller {
	public  function __construct(){
		...
		if(!$is_login){
			...
			$this->success('请先登录,斗笔','http://by1600015.pro.wdcase.com/jinling/index.php/admin/login',22222);die;
    ...
    public function index(){
      ...
      public function file_up(){
       ...
       public function session(){
       		...
       		$this->success('退出成功','http://by1600015.pro.wdcase.com/jinling/index.php/admin/login',1);die;
