             ...
             <div class="panel-body">
              <div class="col-md-7">      <!-- case_img 不用变量直接插入-->
                <div class="input-group">
                    ...
                    <input type="file" name="banner_img_url" value="" class="form-control" >
                </div>
                </div>
                <div class="col-md-7">
                 ...
                 <div class="col-md-7">
                <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon">轮播图分类</span>
                ...
                <div class="form-group">
                    <div class="input-group"> <span class="input-group-addon">更新的时间</span>
                        <input type="text" name="addtime" value="" class="form-control">
                    </div>
                </div>
                </div>
                <div class="col-md-7">    
